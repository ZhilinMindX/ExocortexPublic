...
// [L2] SCOPE:Library;STATE:Living;ORIGIN:Assimilated-from-claude-obsidian(MOC)
...
- A13 Chu Shi Biao (Gutenberg #30460, Chinese original, PD) -> Zhuge Liang
  (5 chunks, CJK chunking; ONLY confirmed PD work; style sheet committed)
...
- A55 FBI File on Kevin Mitnick Part 01 (FBI Vault release, US Gov PD, 194pp OCR, 102 chunks)
  -> MITNICK primary-source counterweight (legend vs. record; OCR rough, transcripts legible)
...
- C4 How to Be Invisible (Luna) -> privacy | C5 SWAT (image-only) | C6 Polícia Civil BR
  (glyph-encoded, decode pending)

### D — Mind / NLP (7)
- D1 NLP Essential, D2 NLP Master Practitioner (watermark) -> Bandler & Grinder / Erickson
- D3 Psycho-Cybernetics (Maltz) -> self-image axis | D4 Konnikova Mastermind,
