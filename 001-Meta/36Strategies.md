...
**Strategy 12: Steal a goat along the way**
**Directive Link:** #17 Expense effort proportionally to impact — Small gains compound. Session Staccato captures micro-updates.

### Chapter 3 — Attacking Strategies

**Strategy 13: Startle the snake by hitting the grass**
**Directive Link:** #39 Session Handshake — Probe to reveal hidden positions. Verify before acting.

**Strategy 14: Raise a corpse from the dead**
**Directive Link:** #41 Precedent Library — Resurrect old decisions for new contexts.

**Strategy 15: Lure the tiger from its mountain**
**Directive Link:** #44 Snippets Protocol — Surgical strikes. Never attack a strong position directly.

**Strategy 16: Let loose to capture**
...
**Strategy 19: Remove firewood from under the pot**
...
**Strategy 25: Replace beams with rotten timbers**
**Directive Link:** #29 The Refactor Imperative — Replace rotten Directives with better ones.

**Strategy 26: Point at mulberry, curse locust**
...
## Cross-References
- [[001-Meta/Kybalion]] — Universal principles underlying all strategy
- [[001-Meta/MoscowRules]] — Modern tradecraft parallels
- [[001-Meta/RedTeamRules]] — Adversarial application
- [[001-Meta/Dokkodo]] — Personal discipline in execution
